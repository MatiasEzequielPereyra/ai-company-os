...
$scriptNames = @(
    ...
    "validate-json-contract.ps1","validate-artifacts.ps1","write-operational-event.ps1","summarize-metrics.ps1","new-agent-workspace.ps1","run-writable-agent.ps1","resolve-writable-required-files.ps1"
)
